    ...
    <div>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScrolled? " bg-opacity-60 duration-100 backdrop-blur-2xl shadow-sm": "" } `}>
        ...
        <div className='flex items-center gap-4'>
          ...
          <a className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4' href="#contact">Contact <Image draggable="false" src={assets.arrow_icon} alt='' className='w-3'/></a>
